...
// no_sporadics_XD0: initial list of 64 pairs [D,N] for which we know that X_0^D(N) has no sporadic points,
// by virtue of having infinitely many degree 2 points. This list comes from Saia24
